...
[![docs](https://img.shields.io/badge/docs-0.17.0-blue.svg)](https://furiosa-ai.github.io/onnxrt/0.17.0/onnxrt/)
...
```toml
[dependencies]
onnxrt = { git = "https://github.com/furiosa-ai/onnxrt", tag = "0.17.0" }
```
